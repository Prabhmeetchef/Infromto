  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-white px-4 pb-10">
      ...
      <p className="text-lg text-black text-center max-w-md mb-8">
        Enter your details below to find the best and cheapest flights for your
        journey.
      </p>

      <form
        onSubmit={handleSubmit}
        className="bg-white shadow-lg rounded-lg px-8 py-6 max-w-lg w-full border-[1px] border-gray-200"
      >
        <div className="mb-4">
          <label
            htmlFor="from"
        ...
        <div className="mb-6">
          ...
          <input
            ...
            onChange={handleInputChange}
            className={`w-full p-3 border ${
              errors.date ? "border-red-500" : "border-red-300"
            } rounded-md focus:outline-none focus:ring-2 focus:ring-red-500`}
          />
          {errors.date && (
